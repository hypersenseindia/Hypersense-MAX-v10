...
[ -f "$CFG" ] || echo "sensitivity_x=$XVAL" > "$CFG"
...
main_menu() {
    while true; do
        ...
        case $CHOICE in
            1) check_activation && dialog --msgbox "Activation Valid" 6 40 || dialog --msgbox "Activation Missing / Expired. Returning to Branding..." 6 60 ;;
            ...
            4) dialog --msgbox "Auto FPS / Touch Optimization Running..." 6 50 ;;
            5) dialog --msgbox "Game Profiles Management Coming Soon" 6 50 ;;
            6) dialog --msgbox "VRAM & Perf Markers Updated" 6 50 ;;
            7) real_time_monitor ;;
            8) XVAL=8; YVAL=8; apply_touch_settings; dialog --msgbox "Defaults restored." 6 40 ;;
            9) dialog --msgbox "Auto Boot / Daemon Settings Configured" 6 50 ;;
            10) clear; exit 0 ;;
        esac
    done
}
...
auto_game_mode &
predictive_booster &
dialog --msgbox "🔥 Welcome to Hypersense v10 🔥\nBrand: AG HYDRAX | Marketing Head: Roobal Sir" 8 60
main_menu
